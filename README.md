...
-RDBMS is a database management software or system used to structure data in the DB, whereas SQL is the language needed to communicate with database within an RDBMS
...
-Another table between the two that acts as a middle ground (or middleware I suppose) called the Joining table, and uses multiple join statements
